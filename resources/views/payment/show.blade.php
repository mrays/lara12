        ...
        <div class="col-12">
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-{{ $invoice->status == 'Paid' || $invoice->status == 'Lunas' ? 'success' : ($invoice->status == 'Overdue' ? 'danger' : ($invoice->status == 'gagal' ? 'danger' : 'warning')) }}">{{ $invoice->status }}</span>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
