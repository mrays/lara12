                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <br>
                                        <small class="text-muted">{{ $invoice->service->package->name ?? 'Package' }} ({{ $invoice->service->billing_cycle ? \App\Http\Controllers\ServiceManagementController::staticTranslateBillingCycle($invoice->service->billing_cycle) : 'Tahunan' }})</small>
                                    </td>
