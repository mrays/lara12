    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-body">
                    <h5 class="mb-0">
                        <i class="bx bx-plus me-2"></i>Tambah Server Baru
                    </h5>
                    <p class="text-muted mb-0">Tambahkan server hosting baru ke sistem</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
                    ...
                    <form method="POST" action="{{ route('admin.servers.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror" 
                                      id="notes" name="notes" rows="3" placeholder="Informasi tambahan tentang server">{{ old('notes') }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bx bx-save me-1"></i>Simpan Server
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <h6 class="fw-semibold">Informasi Server:</h6>
                    <ul class="mb-3">
                        <li><strong>Nama Server:</strong> Nama identifikasi server</li>
                        <li><strong>IP Address:</strong> Alamat IP server</li>
                        <li><strong>Username:</strong> Username untuk SSH/Panel</li>
                        <li><strong>Password:</strong> Password untuk login (akan dienkripsi)</li>
                        <li><strong>Login Link:</strong> URL untuk akses panel (cPanel, Plesk, dll)</li>
                        <li><strong>Expired Date:</strong> Tanggal kadaluarsa sewa server</li>
                    </ul>

                    <h6 class="fw-semibold">Status:</h6>
                    <ul class="mb-3">
                        <li><span class="badge bg-success">Active</span> - Server aktif dan bisa digunakan</li>
                        <li><span class="badge bg-warning">Suspended</span> - Server ditangguhkan</li>
                        <li><span class="badge bg-danger">Expired</span> - Server sudah kadaluarsa</li>
                    </ul>

                    <h6 class="fw-semibold">Contoh Login Link:</h6>
                    <ul class="mb-3">
                        <li>cPanel: <code>https://server.com:2083</code></li>
                        <li>Plesk: <code>https://server.com:8443</code></li>
                        <li>DirectAdmin: <code>https://server.com:2222</code></li>
                        <li>Custom Panel: <code>https://panel.server.com</code></li>
                    </ul>
