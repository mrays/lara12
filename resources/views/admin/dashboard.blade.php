                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm me-3">
                                                <span class="avatar-initial rounded-circle bg-label-primary">{{ strtoupper(substr($invoice->client_name ?? 'N', 0, 1)) }}</span>
                                            </div>
                                            <div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm me-3">
                                                <span class="avatar-initial rounded-circle bg-label-primary">{{ strtoupper(substr($service->client_name ?? 'N', 0, 1)) }}</span>
                                            </div>
                                            <div>
